...
CldibWuQuantizer::CldibWuQuantizer(CLDIB *dib)
{
...
CldibWuQuantizer::~CldibWuQuantizer()
{
	SAFE_FREE(Qadd);
	SAFE_FREE(mb);
	SAFE_FREE(mg);
...
void CldibWuQuantizer::Hist3D(LONG *vwt, LONG *vmr, LONG *vmg, LONG *vmb, float *m2)
{
	int ii, ix, iy;
	int inr, ing, inb;
	int table[256];
...
void CldibWuQuantizer::M3D(LONG *vwt, LONG *vmr, LONG *vmg, LONG *vmb, float *m2)
{
	WORD ind1, ind2;
	BYTE ii, ir, ig, ib;
...
LONG CldibWuQuantizer::Vol(Box *cube, LONG *mmt)
{
	return (mmt[INDEX(cube->r1, cube->g1, cube->b1)] - mmt[INDEX(cube->r1, cube->g1, cube->b0)] - mmt[INDEX(cube->r1, cube->g0, cube->b1)] + mmt[INDEX(cube->r1, cube->g0, cube->b0)] - mmt[INDEX(cube->r0, cube->g1, cube->b1)] + mmt[INDEX(cube->r0, cube->g1, cube->b0)] + mmt[INDEX(cube->r0, cube->g0, cube->b1)] - mmt[INDEX(cube->r0, cube->g0, cube->b0)]);
}
...
LONG CldibWuQuantizer::Bottom(Box *cube, BYTE dir, LONG *mmt)
{
	switch (dir)
	{
	case CCID_RED:
		return (-mmt[INDEX(cube->r0, cube->g1, cube->b1)] + mmt[INDEX(cube->r0, cube->g1, cube->b0)] + mmt[INDEX(cube->r0, cube->g0, cube->b1)] - mmt[INDEX(cube->r0, cube->g0, cube->b0)]);
		break;
	case CCID_GREEN:
		return (-mmt[INDEX(cube->r1, cube->g0, cube->b1)] + mmt[INDEX(cube->r1, cube->g0, cube->b0)] + mmt[INDEX(cube->r0, cube->g0, cube->b1)] - mmt[INDEX(cube->r0, cube->g0, cube->b0)]);
		break;
	case CCID_BLUE:
		return (-mmt[INDEX(cube->r1, cube->g1, cube->b0)] + mmt[INDEX(cube->r1, cube->g0, cube->b0)] + mmt[INDEX(cube->r0, cube->g1, cube->b0)] - mmt[INDEX(cube->r0, cube->g0, cube->b0)]);
		break;
	}
	return 0;
}
...
LONG CldibWuQuantizer::Top(Box *cube, BYTE dir, int pos, LONG *mmt)
{
	switch (dir)
	{
	case CCID_RED:
		return (mmt[INDEX(pos, cube->g1, cube->b1)] - mmt[INDEX(pos, cube->g1, cube->b0)] - mmt[INDEX(pos, cube->g0, cube->b1)] + mmt[INDEX(pos, cube->g0, cube->b0)]);
		break;
	case CCID_GREEN:
		return (mmt[INDEX(cube->r1, pos, cube->b1)] - mmt[INDEX(cube->r1, pos, cube->b0)] - mmt[INDEX(cube->r0, pos, cube->b1)] + mmt[INDEX(cube->r0, pos, cube->b0)]);
		break;
	case CCID_BLUE:
		return (mmt[INDEX(cube->r1, cube->g1, pos)] - mmt[INDEX(cube->r1, cube->g0, pos)] - mmt[INDEX(cube->r0, cube->g1, pos)] + mmt[INDEX(cube->r0, cube->g0, pos)]);
		break;
	}
...
float CldibWuQuantizer::Var(Box *cube)
{
	float dr = (float)Vol(cube, mr);
	float dg = (float)Vol(cube, mg);
	float db = (float)Vol(cube, mb);
	float xx =
			gm2[INDEX(cube->r1, cube->g1, cube->b1)] - gm2[INDEX(cube->r1, cube->g1, cube->b0)] - gm2[INDEX(cube->r1, cube->g0, cube->b1)] + gm2[INDEX(cube->r1, cube->g0, cube->b0)] - gm2[INDEX(cube->r0, cube->g1, cube->b1)] + gm2[INDEX(cube->r0, cube->g1, cube->b0)] + gm2[INDEX(cube->r0, cube->g0, cube->b1)] - gm2[INDEX(cube->r0, cube->g0, cube->b0)];
...
float CldibWuQuantizer::Maximize(Box *cube, BYTE dir, int first, int last, int *cut,
...
bool CldibWuQuantizer::Cut(Box *set1, Box *set2)
{
	BYTE dir;
	int cutr, cutg, cutb;
...
void CldibWuQuantizer::Mark(Box *cube, int label, BYTE *tag)
{
	int r, g, b;
...
CLDIB *
CldibWuQuantizer::Quantize(int PalSize)
{
	int ii, jj;
	BYTE *tag = NULL;
	CLDIB *dst = NULL;
